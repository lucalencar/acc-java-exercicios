...
public class CustomExceptionActivityTest {
	...
	public static void main(String[] args) throws CustomExceptionActivity {
		String testName = "Stacie";
		validateUser(testName);
	}
	...
	static void validateUser(String name) throws CustomExceptionActivity {
		...
		int flag = 0;
		for (int i = 0; i < 4; i++) {
			// 2 - Write code to check if parameter name contains a value which is found in
			// validUsers array and change flag's value accordingly
